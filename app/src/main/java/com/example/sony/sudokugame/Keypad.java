...
//Класс-клавитура по вводу значений с помощью Dialog
public class Keypad extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViews();
        //Отображение доступных цифр на клавиатуре
    ...
    //Привязка объектов к кнопкам из layout
    ...
    //Сравнивает с допустимыми числами(значениями)
    ...
    //Метод по установке в клетку выбранного значения
